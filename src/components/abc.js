            ...
            <div className="col-md-7 col-lg-8 ms-auto me-auto">
              ...
              <div className="row g-3">
                <div className="col-sm-6">
                  ...
                  {errors.firstname && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                </div>

                <div className="col-sm-6">
                  <label className="form-label">Last name</label>
                  <input type="text" className="form-control" {...register('lastname', { required: true })} />
                  {errors.lastname && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                </div>
                ...
                <div className="col-12">
                  ...
                  {errors.gender && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                </div>

                <div className="col-12">
                  <label className="form-label">Email</label>
                  <input type="email" className="form-control" placeholder="you@example.com" {...register('email', { required: true })} />
                  {errors.email && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                </div>
                ...
                <div className="col-md-5">
                  ...
                  {errors.country && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                </div>
                ...
                <div className="col-md-4">
                  ...
                  {errors.state && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                </div>

                <div className="col-md-3">
                  <label className="form-label">Pin / Zip</label>
                  <input type="text" className="form-control" {...register('pin', { required: true })} />
                  {errors.pin && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                </div>
              </div>
              ...
              <div className="row g-3">
                <div className="col-12">
                  ...
                  {errors.prof_info?.skills && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                </div>
              </div>
                        ...
                        <div className="card-body">
                          ...
                          <div className="row g-3">
                            <div className="col-6">
                              ...
                              {errors.prof_info?.experience?.[index]?.comp_name && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                            </div>
                            <div className="col-6">
                              ...
                              {errors.prof_info?.experience?.[index]?.duration && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                            </div>
                            <div className="col-12">
                              ...
                              {errors.prof_info?.experience?.[index]?.responsibilities && <p style={{ color: 'red', paddingTop: '5px' }}>This field is required.</p>}
                            </div>
                          </div>
                        </div>
                      </div>
